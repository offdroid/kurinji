...
{
    // publics
    pub fn bind_mouse_button_pressed(&mut self,
                                     code: MouseButton,
                                     action: &str)
                                     -> &mut Kurinji
    {
    ...
    pub fn unbind_mouse_button_pressed(&mut self,
                                       button: MouseButton)
                                       -> &mut Kurinji
    {
    ...
    pub fn bind_mouse_motion(&mut self,
                             axis: MouseAxis,
                             action: &str)
                             -> &mut Kurinji
    {
    ...
    // crates
    // systems
    pub(crate) fn mouse_button_press_input_system(mut input_map: ResMut<Kurinji>,
    ...
    pub(crate) fn mouse_move_event_system(mut input_map: ResMut<Kurinji>,
                                          mut state: EventReader<MouseMotion>)
    {
        if let Some(value) = state.iter().next()
        {
