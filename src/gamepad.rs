...
impl Kurinji
{
    // publics
    // buttons
    pub fn bind_gamepad_button_pressed(&mut self,
    ...
    pub fn bind_gamepad_button_pressed_for_player(&mut self,
                                                  player: usize,
                                                  pad_button: GamepadButtonType,
                                                  action: &str)
                                                  -> &mut Kurinji
    ...
    pub fn unbind_gamepad_button_pressed_for_player(&mut self,
                                                    player: usize,
                                                    pad_button: GamepadButtonType)
                                                    -> &mut Kurinji
    {
    ...
    // axis
    pub fn bind_gamepad_axis(&mut self,
                             axis: GamepadAxis,
                             action: &str)
                             -> &mut Kurinji
    {
    ...
    pub fn bind_gamepad_axis_for_player(&mut self,
                                        player: usize,
                                        axis: GamepadAxis,
                                        action: &str)
                                        -> &mut Kurinji
    ...
    pub fn unbind_gamepad_axis(&mut self, pad_axis: GamepadAxis)
                               -> &mut Kurinji
    {
    ...
    pub fn unbind_gamepad_axis_for_player(&mut self,
                                          player: usize,
                                          axis: GamepadAxis)
                                          -> &mut Kurinji
    {
    ...
    pub(crate) fn get_player_handle_for_gamepad(self,
                                                pad: Gamepad)
                                                -> Option<usize>
    {
    ...
    pub(crate) fn gamepad_event_system(mut input_map: ResMut<Kurinji>,
                                       mut gamepad_event: EventReader<GamepadEvent>)
    {
        if let Some(value) = gamepad_event.iter().next()
        {
