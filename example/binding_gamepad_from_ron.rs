...
fn setup(mut kurinji: ResMut<Kurinji>)
{
    ...
    kurinji.set_bindings_with_ron(&binding_ron)
           ...
           .set_strength_curve_function("AIM_UP_PLYR1", |x| -> f32 {
               x.powi(2)
           })
           .set_strength_curve_function("AIM_UP_PLYR2", |x| -> f32 {
               x.powi(2)
           })
           .set_strength_curve_function("AIM_UP_PLYR3", |x| -> f32 {
               x.powi(2)
           })
           .set_strength_curve_function("AIM_UP_PLYR4", |x| -> f32 {
               x.powi(2)
           })
           .set_strength_curve_function("AIM_DOWN_PLYR1", |x| -> f32 {
               x.powi(2)
           })
           .set_strength_curve_function("AIM_DOWN_PLYR2", |x| -> f32 {
               x.powi(2)
           })
           .set_strength_curve_function("AIM_DOWN_PLYR3", |x| -> f32 {
               x.powi(2)
           })
           .set_strength_curve_function("AIM_DOWN_PLYR4", |x| -> f32 {
               x.powi(2)
           })
           .set_strength_curve_function("AIM_LEFT_PLYR1", |x| -> f32 {
               x.powi(2)
           })
           .set_strength_curve_function("AIM_LEFT_PLYR2", |x| -> f32 {
               x.powi(2)
           })
           .set_strength_curve_function("AIM_LEFT_PLYR3", |x| -> f32 {
               x.powi(2)
           })
           .set_strength_curve_function("AIM_LEFT_PLYR4", |x| -> f32 {
               x.powi(2)
           })
...
fn action_system(input_map: Res<Kurinji>,
